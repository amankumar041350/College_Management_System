...
class home:
    def __init__(self,root) -> None:
        ...
        def login_function():
            ...
            if root.txt_pass.get()=="" or root.txt_user.get()=="":
             ...
             cur=con.cursor()
             cur.execute("select * from admin_table where id=%s and password=%s",(self.root.txt_user.get(),self.root.txt_pass.get()))
             row=cur.fetchone()
             if row==None:
        ...
        title=Label(Frame_login,text="Administrator Login Here",font=("Impact",35,"bold"),fg="#d77337",bg="white").place(x=90,y=30)
        ...
        lbl_pass=Label(Frame_login,text="Password",font=("Goudy old style",15,"bold"),fg="gray",bg="white").place(x=90,y=220)
